    ...
    <>
      {!showCompact ? (
        <header className="absolute top-0 z-40 w-full pt-4">
          <div className="mx-4 rounded-2xl border border-brand-secondary/10 bg-white shadow-sm sm:mx-6 lg:mx-8">
      ...
      <AnimatePresence>
        {showCompact ? (
          ...
          >
            <div className="mx-4 rounded-2xl border border-brand-secondary/10 bg-white/95 shadow-sm backdrop-blur sm:mx-6 lg:mx-8">
